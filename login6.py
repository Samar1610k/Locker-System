                                ...
                                for (x,y,w,h) in features:
                                    ...
                                    with conn:
                                        ...
                                        if confidence>77:
                                            ...
                                            Label(screen1,text=f"Welcome:{un} in Locker System",font=('Microsoft YaHei UI Light',11,'bold')).place(x=20,y=20)

                                            Button(screen1,width=20,pady=7,text='Gold_Locker',bg='#57a1f8',fg='white',border=2,font=('Microsoft YaHei UI Light',11,'bold')).place(x=100,y=80)
                                            
                                            Button(screen1,width=20,pady=7,text='Silver_Locker',bg='#57a1f8',fg='white',border=2,font=('Microsoft YaHei UI Light',11,'bold')).place(x=100,y=170)

                                            Button(screen1,width=20,pady=7,text='Valuable_Things',bg='#57a1f8',fg='white',border=2,font=('Microsoft YaHei UI Light',11,'bold')).place(x=100,y=250)
